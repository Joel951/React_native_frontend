    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                console.log("Error Messager", error);
            }
        };
        ...
        <>
            <SafeAreaView
                ...
                <ScrollView>
                    ...
                    />
                    {/* DropDown Products Bar "Hot Deals" */}
                    <View
                        style={{
                            marginHorizontal: 10,
                            marginTop: 20,
                        ...
                        {addresses?.map((item, index) => (
                            <Pressable
                                ...
                                style={{
                                    width: 140,
                                    height: 140,
                                    borderColor: selectedAddress === item ? "#ff9812" : "#D0D0D0",
                                    borderWidth: 1,
                                    padding: 10,
                                    justifyContent: "center",
                                    alignItems: "center",
                                    ...
                                    marginRight: 15,
                                    marginTop: 10,
                                    backgroundColor: selectedAddress === item ? "#f4d35e" : "white"
