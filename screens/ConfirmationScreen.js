...
const ConfirmationScreen = () => {
    ...
    const fetchAddresses = async () => {
        try {
            ...
            console.log("Fetchaddresserror", error);
        }
    };
    // console.log("Cinfirmation", addresses);
    ...
    return (
        <ScrollView style={{ marginTop: 55 }}>
            ...
            {/* Choouse your delivery option SETP 2*/}
            ...
            {/* Choouse your PAYMENT option SETP 3*/}
            {currentStep == 2 && (
                <View style={{ marginHorizontal: 20 }}>
            ...
            {currentStep == 3 && selectedOption === "cash" && (
                <View style={{ marginHorizontal: 20 }}>
                    ...
                    <View style={{
                        ...
                        <Text>
                            Shipping to
                            <Text style={{ color: '#014f86' }}>  {selectedAddress?.name}</Text>
                        </Text>
